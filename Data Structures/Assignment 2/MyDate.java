...
Methods: default constructor - sets date to Jan 1, 2018
         toString (): String - prints date in year/month/day format
 		 toFile (): String - prints the correctly formatted string of into a file (year month day)
...
public class MyDate {
	...
	// A method to send to files
	public String toFile() { return new String ("" + month + " " + day + " " + year);}
