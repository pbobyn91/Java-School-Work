...
Methods: default constructor - does nothing
		 ...
		 toString (): String - prints out a string with all the Magazine class data.
 		 toFile(): String - prints this as a string in the correct format to a file
 		 addFromFile (Scanner): boolean - accepts this type of information from a file, called from the library class
...
public class Magazine extends Resource {
	...
	// sends a correctly formatted string to a file
	public String toFile() {
		String output = String.format("m %s %s", super.toFile(), edition.toFile() );
		return output;
	}
